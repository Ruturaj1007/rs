...
@st.cache_data
def load_data():
    file_path = os.path.join(os.getcwd(), 'SerieA/serieAdata.csv')  # If script runs in Bundesliga folder
...
def seriea():
    ...
    st.image("SerieA/logo.png", width=300)
    ...
    team_names = [
        'Bologna', 'Fiorentina', 'Inter', 'Juventus', 'Lecce', 'Perugia', 'Piacenza', 
        'Venezia', 'Lazio', 'Bari', 'Reggina', 'Udinese', 'Cagliari', 'Milan', 'Parma', 'Roma', 
        'Torino', 'Verona','Napoli', 'Atalanta', 'Brescia', 'Vicenza', 'Chievo', 
        'Como', 'Modena', 'Empoli', 'Ancona', 'Sampdoria', 'Siena', 'Palermo', 'Livorno', 'Messina', 
        'Ascoli', 'Treviso', 'Catania', 'Genoa', 'Cesena', 'Novara', 'Pescara', 'Sassuolo', 'Frosinone',
