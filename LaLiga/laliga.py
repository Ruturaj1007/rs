...
@st.cache_data
def load_data():
    file_path = os.path.join(os.getcwd(), 'LaLiga/laligadata.csv')  # If script runs in Bundesliga folder
...
def laliga():
    ...
    st.image("LaLiga/logo.png", width=300)

    st.title('LaLiga Football Match Outcome Predictor')
